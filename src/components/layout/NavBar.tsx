...
export default function NavBar() {
  return (
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-sm">
      ...
      {/* Optional: mobile utility bar for quick call access */}
      <div className="md:hidden border-t border-gray-200 bg-white/95">
        <div className="mx-auto max-w-7xl px-4 py-2 flex justify-end">
          <Link
            href="tel:07932030303"
            className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-red-600 rounded-md"
            aria-label="Tap to call RMS Tyres now"
          >
            <PhoneIcon className="w-5 h-5" aria-hidden="true" />
            Call Now
          </Link>
